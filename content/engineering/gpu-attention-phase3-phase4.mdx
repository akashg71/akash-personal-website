...
![Roofline plot: naive and Triton plotted against the T4's memory-bound ramp and compute-bound ceiling, both far to the left of the ridge point](/images/gpu-attention/roofline.png)
