...
| #9577 | 1.37% | Institutionally confined or vulnerable people |
...
Not medical at all. This feature encodes **people under institutional control or confinement with limited agency** — medical patients, prisoners, detainees, refugees, addicts, juveniles. The SAE independently discovered that hospitals, prisons, and detention centres share a deep structural similarity in how language describes the people inside them.

That's not something I would have hypothesised going in. It's a concept that cuts across what we'd normally consider separate domains.
...
This is what a clean causal result looks like — small but real, and it confirms the label.
